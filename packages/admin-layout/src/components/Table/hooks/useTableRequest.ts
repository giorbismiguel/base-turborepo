...
export const useTableRequest = (queryFunction: ((params: any, config: any) => Promise<any>), filters?: any, config?: any) => {
    ...
    }, [query, filtersObj, page, rowsPerPage, order.orderBy, order.order, queryFunction, config]);
