...
import { Avatar, ListItemAvatar, Typography, List, Divider, ListItemText } from '@mui/material';
...
const NotificationDrawer = ({ headerText, headerActionText, handleActionText, notifications, isLoading, open, onClose: handleClose }: NotificationDrawerProps & DrawerProps) => {
    let content = null;
