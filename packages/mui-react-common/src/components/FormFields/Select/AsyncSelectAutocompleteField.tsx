...
import SelectAutocompleteField, {
  SelectAutocompleteFieldProps,
} from "./SelectAutocompleteField";
...
export type AsyncSelectAutocompletedProps = Omit<
  SelectAutocompleteFieldProps,
  "open" | "onOpen" | "onClose" | "options" | "loading" | "onInputChange"
> & {
...
const AsyncSelectAutocompleteField = ({
  ...
  const { isLoading, data, isError } = useFindEntity(
    fetchFunc,
    queryKey,
    search,
    fetchOption,
