...
const WrapperChip = ({statusColor, fullWidth, pointer, ...props}: StatusProps) => {
    // @ts-ignore
    return <Chip {...props}/>
}
...
export const StatusItem = ({value, fullWidth, pointer, size = 'small'}: StatusProps) => {
