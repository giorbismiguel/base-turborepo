...
const initialValue: InterfaceUser = {
    firstName: '',
    lastName: '',
    email: '',
    phone: '',
...
const useUserCreateForm = (defaultValues: InterfaceUser = initialValue, onClose: () => void) => {
    ...
    const { mutate, error, isLoading, isSuccess, data } = useMutation((user: InterfaceUser) => UserServices.saveOrUpdate({
        _id: user?._id,
