...
function TermsConditions() {
    ...
    return (<AnonymousLayout>
            ...
            Termly’s Terms Of Use
            Last updated June 30, 2021

            AGREEMENT TO TERMS
            We are Termly Inc., doing business as Termly (“Termly,” “we,” “us,” or “our”), a company registered in the
            State of Delaware. We operate the website https://termly.io (the “Website”) through which we provide you our
            services, (collectively, the “Services” which include the provision and use of the Website).

            You can contact us by phone at (855) 234-5020, by email at info@termly.io, or by post to Termly Inc., 8 The
            Grn Ste B, Dover, DE 19901.

            These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf
            of an entity (“you”) and concerning your access to and use of the Website and the Services. You agree that
            by accessing the Services, you have read, understood, and agree to be bound by all of these Terms of Use. IF
            YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES
            AND YOU MUST DISCONTINUE USE IMMEDIATELY.

            Supplemental terms and conditions or documents that may be posted on the Website from time to time are
            hereby expressly incorporated herein by reference. We reserve the right, in Termly’s sole discretion, to
            make changes or modifications to these Terms of Use from time to time. We will alert you about any changes
            ...
            informed as each time you access the Services, you will be subject to, and will be deemed to have been made
            aware of and to have accepted, the then applicable Terms of Use.

            The Services are intended for business users who are at least 18 years old. Persons under the age of 18 are
            ...
            We are not lawyers nor a law firm, but we help you with compliance in relation to your privacy and
            contractual obligations. We provide you a software (the “Software”), that you access remotely via the cloud,
            that you can use for (a) consent management (“Consent Platform”); and (b) the generation of policies, legal
            agreements, disclaimers, and other documents generated by the Services using information related to your
            business or organization that you enter into the Software (collectively “Forms”).

            The information, Consent Platform, and Forms provided when using the Services are not intended for
            ...
            The Services are not tailored to comply with industry-specific regulations (including Health Insurance
            Portability and Accountability Act (HIPAA), Federal Information Security Management Act (FISMA), etc.), so
            if your interactions would be subjected to such laws, you may not use these Services. You may not use the
            Services in a way that would violate the Gramm-Leach-Bliley Act (GLBA).

            Using Termly’s Forms
            You may use any Forms generated by the Software through your use of our generator(s) for your business or
            organization. It is your responsibility to determine whether the Forms generated by the Software are
            appropriate for your use. From time to time, we may notify you that a particular Form may need to be updated
            in response to changes in applicable laws or other guidance, rules or regulations, and you are responsible
            for determining whether to update the Forms used in your business or organization.

            WE DO NOT REPRESENT THAT THE FORMS WILL MEET YOUR SPECIFIC GOALS, PROTECT YOUR SPECIFIC INTERESTS, OR
            WITHSTAND CHALLENGES TO THEIR LEGAL OR FACTUAL SUFFICIENCY. THE FORMS ARE NOT PROVIDED WITH ANY GUARANTY,
            WARRANTY, OR REPRESENTATION AS TO QUALITY OR SUITABILITY FOR ANY PARTICULAR PURPOSE. The Forms are general
            in nature and may not be sufficient to protect you against a specific risk, problem or dispute. Our
            software’s generation of a Form does not constitute the practice of law and is not legal counsel or advice.
            You should not rely on a Form as a substitute for consultation with an attorney.

            Using Termly’s Consent Platform
            If you use Termly’s Consent Platform, you may access the features of the Software designed to track and
            monitor consents given or withdrawn by the users of your website(s) with regard to cookies or similar
            tracking technology used on such website(s).

            TERMLY IS NOT LIABLE FOR YOUR FAILURE TO DISABLE OR REMOVE COOKIES IF YOUR USERS DO NOT CONSENT TO THEIR
            USE.

            2. INTELLECTUAL PROPERTY RIGHTS
            Unless otherwise indicated, we retain all right, title, and interest in and to the Software and the Website,
            including without limitation all graphics, user interfaces, databases, functionality, software, website
            designs, audio, video, text, photographs, graphics, logos, and trademarks or service marks reproduced
            through the System. These Terms of Use do not grant you any intellectual property license or rights in or to
            the Software and the Website or any of its components, except to the limited extent that these Terms of Use
            specifically sets forth your license rights to it. You recognize that the Software and the Website and their
            components are protected by copyright and other laws.

            Conditioned upon your compliance with these Terms of Use and, if applicable, your payment of the
            Subscription Fees, we grant you the rights to reproduce, modify, and publicly display the Forms and use the
            Consent Platform (all together “Content”) on your website or mobile application. In addition, as to a Form
            intended to serve as a legal agreement between you and a counterparty, we grant you the right to distribute
            that Form to the counterparty to the extent reasonably necessary for your counterparty to execute the
            ...
            by your own business or organization. The Forms and the Consent Platform generated by the Software are
            licensed, not sold, and you receive no title to or ownership of the Forms or the Consent Platform.

            You and Termly agree that none of the Feedback (as defined below) you or your users provide to us constitute
            confidential information, and nothing in these Terms of Use or in our dealings arising out of or related to
            subject matter of these Terms of Use will restrict our right to use, profit from, disclose, publish, keep
            secret, or otherwise exploit Feedback, without compensating or crediting you or the user in question. You
            hereby grant us a perpetual, irrevocable right and license to exploit the Feedback in any and every way and
            subject to applicable law waive any moral rights in such Feedback. Feedback will not constitute your
            confidential information. (“Feedback” refers to any suggestion or idea for improving or otherwise modifying
            any of Termly’s products or services.)
            ...
            4. USER REGISTRATION
            You may be required to register with the Services. You agree to keep your password confidential and will be
            ...
            5. FEES AND PAYMENT
            Termly offers free and paid account options. You can create a free account (“Free Account”) without
            providing any credit card information, but your access to our Website’s features will be limited. Depending
            on your needs, you may want to access more or all of Termly’s Services by creating or upgrading to a paid
            account (“Paid Account”). You can create or upgrade to a Paid Account by signing up for one of Termly’s
            subscription plans (“Subscription Plans” and each a “Subscription”).

            You can find information about our pricing options and available Subscription Plans on the following page
            here.

            Fees for Subscriptions
            Fees for Subscriptions (“Subscription Fees”) shall be based on the length of your Subscription
            (“Subscription Period”). All Subscriptions will auto-renew at the end of the then Subscription Period.

            We bill you for all initial and recurring Subscription Fees through an online billing account and you agree
            to provide (and keep updated) current, complete, and accurate purchase and account information including
            email address, payment method, and payment card expiration date, so that we can process your payments and
            contact you as needed.

            Our prices may be updated from time to time so please make sure that you check our current Subscription Fees
            before placing your order. All payments shall be in USD, EUR, or GBP.
            ...
            You agree to pay all charges or fees at the prices then in effect for your Subscription, and you authorize
            us to charge your chosen payment provider for any such amounts upon placing your order. If your Subscription
            is subject to recurring charges, then you consent to our charging your payment method on a recurring basis
            without requiring your prior approval for each recurring charge, until you notify us of your cancellation in
            accordance with the cancellation information described in this section below.

            We reserve the right to correct any errors or mistakes in pricing, even if we have already requested or
            received payment. We also reserve the right to refuse any order placed through the Services. In such case we
            will notify you by email and refund you any Subscription Fees that you have paid.

            Sales Tax
            Sales tax will be added to the price of purchases as deemed required by us. Amounts due under these Terms of
            Use are payable to us without deduction and are net of any tax, tariff, duty, or assessment imposed by any
            government authority (national, state, provincial, or local), including without limitation any sales, use,
            excise, ad valorem, property, withholding, or value-added tax, whether or not withheld at the source
            (collectively, “Sales Tax”). Except as forbidden by applicable law, we may require that you submit
            applicable Sales Taxes to us. However, the preceding sentence does not apply to the extent that you are tax
            exempt, provided you give us a valid tax exemption certificate within thirty (30) days of the start of your
            Subscription. Our failure to include any applicable tax in an invoice will not waive or dismiss the parties’
            rights or obligations pursuant to this Section. If applicable law requires withholding or deduction of Sales
            Taxes or any other tax or duty, you shall separately pay us the withheld or deducted amount, over and above
            fees due. For the avoidance of doubt, this Section does not govern taxes based on our net income.

            Account Upgrades, Downgrades, and Cancellations
            If you created a Free Account but want to upgrade to a Paid Account, your upgrade will occur immediately
            upon payment of the relevant Subscription Fees and your Subscription Period will run from the date of your
            upgrade.

            If you created or upgraded to a Paid Account, and you want to:

            Upgrade to a different Subscription Plan: Your upgrade will occur immediately at a prorated rate upon
            payment of the price difference between the two Subscription Plans for the remainder of your Subscription
            Period. Your upgraded Subscription Plan will run until the end of the initial Subscription Period and will
            auto-renew as the upgraded Subscription Plan.
            Cancel your Subscription Plan and/or downgrade your Subscription: Your downgrade will take place following
            the end of your current Subscription Period.
            PLEASE NOTE THAT WHEN YOU DOWNGRADE YOUR ACCOUNT, YOU WILL ONLY BE ABLE TO ACCESS THE SERVICES AVAILABLE
            WITHIN YOUR NEW SUBSCRIPTION PLAN, AND THEREFORE YOU MAY LOSE ACCESS TO ANY ADDITIONAL FORMS OR ANY PREMIUM
            CONSENT PLATFORM FEATURES CREATED OR AVAILABLE THROUGH YOUR PREVIOUS SUBSCRIPTION PLAN.

            How to Cancel a Subscription Plan
            You can cancel your Subscription Plan at any time by logging into your account or contacting us using the
            contact information provided below. Your cancellation will take effect at the end of your current
            Subscription Period.

            Except as stated in this Section, we will not be required to refund Subscription Fees under any
            circumstances.
            ...
            Systematically retrieve data, Forms, or other Content from the Services to create or compile, directly or
            ...
            Engage in any automated use of the Website or Services, such as using scripts to send comments or messages,
            ...
            for any revenue-generating endeavor or commercial enterprise beyond the license granted to you under these
            Terms of Use.
            ...
            Attempt to bypass any measures of the Website or Software designed to prevent or restrict access to the
            ...
            interferes with any party’s uninterrupted use and enjoyment of the Software or the Services or modifies,
            ...
            offline reader that accesses the Software or the Services, or using or launching any unauthorized script or
            other software.
            Disparage, tarnish, or otherwise harm, in our opinion, Termly, the Software, Website, and/or the Services.
            Use the Services in a manner inconsistent with any applicable laws or regulations.
            7. THIRD-PARTY WEBSITES AND CONTENT
            The Services may contain (or you may be sent via the Services) links to other websites (“Third-Party
            ...
            We reserve the right, but not the obligation, to: (1) monitor the Services for violations of these Terms of
            ...
            discretion and without limitation, notice, or liability, to remove from the Services or otherwise disable
            ...
            9. PRIVACY NOTICE
            We care about data privacy and security. Please review our Privacy Notice to understand our use of your
            personal information. You acknowledge that you have reviewed and understand our Privacy Notice.

            Please be advised the Services is hosted in the United States. If you access the Services from any other
            region of the world with laws or other requirements governing personal data collection, use, or disclosure
            that differ from applicable laws in the United States, then through your continued use of the Services, you
            are transferring your data to the United States, and you agree to have your data transferred to and
            ...
            Designated Copyright Agent using the contact information provided below (a “Notification”). A copy of your
            ...
            been infringed, or, if multiple copyrighted works on the Services are covered by the Notification, a
            representative list of such works on the Services; (3) identification of the material that is claimed to be
            ...
            reasonably sufficient to permit us to contact the complaining party, such as an address, telephone number,
            and, if available, an email address at which the complaining party may be contacted; (5) a statement that
            the complaining party has a good faith belief that use of the material in the manner complained of is not
            authorized by the copyright owner, its agent, or the law; and (6) a statement that the information in the
            ...
            contact information provided below (a “Counter Notification”). To be an effective Counter Notification under
            ...
            that the disabled or removed content was removed by mistake or misidentification, you may be liable for
            ...
            IF WE REASONABLY CONSIDER THAT SUCH PERSON IS IN BREACH OF THESE TERMS OF USE, OUR ACCEPTABLE USE POLICY, OR
            OF ANY APPLICABLE LAW OR REGULATION, INCLUDING WITHOUT LIMITATION BREACHES OF ANY REPRESENTATION, WARRANTY,
            ...
            INFORMATION THAT YOU POSTED AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION IF WE CONSIDER THAT YOU
            HAVE BREACHED, OR ARE LIKELY TO BREACH, ANY OF THE ABOVE.
            ...
            We reserve the right to change, modify, or remove the Content or the Services from time to time to comply
            with new laws or regulations or to update our offerings. We also reserve the right to modify or discontinue
            all or part of the Services if Termly were to close down or if we decide to change Termly’s business
            offering. We will not be liable to you or any third party for any modification, price change, suspension, or
            ...
            Services from time to time and will endeavor to give you notice of such changes. You agree that we have no
            ...
            Nothing in these Terms of Use will be construed to obligate us to maintain and support the Services or to
            ...
            the State of Delaware applicable to agreements made and to be entirely performed within the State of
            ...
            Disputes expressly provided below) informally for at least thirty (30) days before initiating arbitration or
            litigation (as applicable per below). Such informal negotiations commence upon written notice from one Party
            to the other Party.
            ...
            required by the applicable AAA rules or applicable law, the arbitration will take place in Kent County, DE.
            ...
            prosecuted in the state and federal courts located in Kent County, DE, and the Parties hereby consent to,
            ...
            If the Parties are unable to resolve a Dispute through informal negotiations as set out in this Section (see
            Informal Negotiations above), you hereby agree to the exclusive jurisdiction of the courts of Kent County,
            DE, in relation to any dispute which may arise in connection with these Terms of Use and/or your use and
            ...
            16. DISCLAIMER
            THE SERVICES ARE PROVIDED ON AN “AS-IS” AND “AS-AVAILABLE” BASIS. YOU AGREE THAT YOUR USE OF OUR SERVICES
            WILL BE AT YOUR SOLE RISK. TO THE FULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM ALL WARRANTIES, EXPRESS OR
            IMPLIED, IN CONNECTION WITH THE SOFTWARE OR THE SERVICES AND YOUR USE THEREOF, INCLUDING, WITHOUT
            LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND
            NON-INFRINGEMENT.

            WE MAKE NO WARRANTIES OR REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE SERVICES, THE CONTENT OR
            ANY THIRD-PARTY CONTENT AND WE WILL ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY (1) ERRORS, MISTAKES, OR
            ...
            INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM THE SERVICES, (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR
            ...
            OFFERED BY A THIRD-PARTY WEBSITE AND WE WILL NOT BE A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR MONITORING
            ANY TRANSACTION BETWEEN YOU AND ANY THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES. AS WITH THE PURCHASE OF A
            PRODUCT OR SERVICE THROUGH ANY MEDIUM OR IN ANY ENVIRONMENT, YOU SHOULD USE YOUR BEST JUDGMENT AND EXERCISE
            CAUTION WHERE APPROPRIATE.

            17. LIMITATIONS OF LIABILITY
            IN NO EVENT WILL WE OR TERMLY’S DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY
            INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, OR ANY (DIRECT OR INDIRECT):
            (A) LOSS OF DATA, (B) LOST PROFIT, OR (C) LOST REVENUE OR OTHER DAMAGES ARISING FROM YOUR USE OF THE
            ...
            REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE LESSER OF (A) THE AMOUNT PAID, IF
            ANY, BY YOU TO US DURING THE SIX (6) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING AND (B) THE SUM OF
            US$100.

            CERTAIN STATE LAWS AND COUNTRIES’ LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR
            ...
            of: (1) your contributions; (2) use of the Services; (3) breach of these Terms of Use; (4) any breach of
            ...
            agree that you shall independently back up all your data and waive any right of action against us arising
            from any such loss or corruption of such data.

            20. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
            Visiting the Website or using the Services, sending us emails, and completing online forms constitute
            ...
            on the Services, satisfy any legal requirement that such communication be in writing.
            ...
            Services constitute the entire agreement and understanding between you and Termly. You confirm that you have
            not relied on any prior or side statement, agreement, or representation, whether these were oral or written,
            ...
            You and Termly are independent contractors and shall so represent ourselves in all regards. There is no
            ...
            You and Termly agree that these Terms of Use will not be construed in favor of or against either party by
            reason of authorship.

            You shall not (a) permit any third party to access or use the Services or Software in violation of any U.S.
            law or regulation; or (b) export any software provided by us or otherwise remove it from the United States
            except in compliance with all applicable U.S. laws and regulations. Without limiting the generality of the
            foregoing, you shall not permit any third party to access or use the Services in, or export the Software to,
            a country subject to a United States embargo (as of the Effective Date, Cuba, Iran, North Korea, Sudan, and
            Syria).

            We may send notices pursuant to these Terms of Use to the email address you provided us, and such notices
            will be deemed received twenty-four (24) hours after they are sent. You may send notices pursuant to these
            Terms of Use to support@termly.io, and such notices will be deemed received seventy-two (72) hours after
            they are sent.

            No delay, failure, or default, other than a failure to pay any fees when due, will constitute a breach of
            these Terms of Use to the extent such delay, failure, or default is caused by epidemics or pandemics, acts
            of war, terrorism, hurricanes, earthquakes, other acts of God or of nature, any law or any action taken by a
            government or public authority, non-performance by suppliers or subcontractors, interruption or failure of
            utility service, strikes or other labor disputes, riots or other acts of civil disorder, embargoes, or other
